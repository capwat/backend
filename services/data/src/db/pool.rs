...
use super::ext::{DbErrorExt2, SqlxErrorExt};
use super::{PoolConnection, Transaction};
use crate::config;
...
impl capwat_kernel::error::ReportIntoError for PoolError {
  fn category(&self) -> capwat_types::Error {
    match self {
      Self::Readonly => capwat_types::Error::ReadonlyMode,
      _ => capwat_types::Error::Internal,
    }
  }
}
