...
use crate::error::BeginTransactError;
use crate::pool::PgConnection;

use super::Transaction;

pub struct TransactionBuilder<'a> {
    pub(super) connection: PgConnection<'a>,
...
impl<'a> TransactionBuilder<'a> {
    pub(crate) const fn new(connection: PgConnection<'a>, is_testing: bool) -> Self {
        Self {
            connection,
    ...
    pub async fn build(self) -> Result<Transaction<'a>, BeginTransactError> {
        crate::transaction::Transaction::new(self).await
    }
}

impl QueryFragment<Pg> for TransactionBuilder<'_> {
